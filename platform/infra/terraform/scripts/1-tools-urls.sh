...
JUPYTERHUB_URL="https://$DOMAIN_NAME/jupyterhub"
...
echo -e "${BOLD}+----------------+-------------------------------------------------------------------+------------------------------------------+${NC}"
echo -e "${BOLD}|${NC} ${GREEN}$(pad_string "JupyterHub" $TOOL_COL)${NC}${BOLD} |${NC} ${YELLOW}$(pad_string "$JUPYTERHUB_URL" $URL_COL)${NC}${BOLD} |${NC} $(pad_string "user1 / $USER_PASSWORD" $CRED_COL)${BOLD} |${NC}"
echo -e "${BOLD}+----------------+-------------------------------------------------------------------+------------------------------------------+${NC}"
...
update_workshop_var "WORKFLOWS_URL" "$WORKFLOWS_URL"
update_workshop_var "JUPYTERHUB_URL" "$JUPYTERHUB_URL"
update_workshop_var "KEYCLOAK_ADMIN_URL" "$KEYCLOAK_ADMIN_URL"
update_workshop_var "GITLAB_URL" "$GITLAB_URL"
update_workshop_var "GRAFANA_URL" "$GRAFANA_URL"
