...
# ===== ESO Pod Identity =====
# Mirrors crossplane-pod-identity chart's eso identity — must exist before ArgoCD
# so ExternalSecrets can read from Secrets Manager immediately on first sync.
